...
$subject = "Open Day Booking" ;

$formurl = "" ;
$errorurl = "http://localhost:8080/od-oops.php" ;
$thankyouurl = "http://localhost:8080/od-thx.php" ;
//$errorurl = "http://www.ferndaledental.co.uk/od-oops.php" ;
//$thankyouurl = "http://www.ferndaledental.co.uk/od-thx.php" ;
