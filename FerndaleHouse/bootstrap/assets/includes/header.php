                    ...
                    <svg version="1.1" id="ferndale-logo" class="img-responsive" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                        ...
                        <defs>
                            <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%">
                                ...
                                <stop offset="30%" style="stop-color:rgb(102,179,214);stop-opacity:1"></stop>
                                <stop offset="50%" style="stop-color:rgb(102,179,214);stop-opacity:1"></stop>
                                <stop offset="85%" style="stop-color:rgb(102,179,214);stop-opacity:1"></stop>
                        ...
                        <g>
                            <path  class="ecg" stroke="url(#gradient)" d="M1140.7,108.7c-63.7,0-51.1-28.3-79.1-28.3c-28.3,0-27.7,96.3-32,96.3c-6,0-13-164.7-18.3-164.7
