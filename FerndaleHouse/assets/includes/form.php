<div class="form-holder">
    ...
    <form id="enquiry-form" name="enquiryform" action="/assets/php/enquiry.php" method="post" data-ajax="false">                                               
        ...
        <div class="form-group">
            ...
            <button id="submit" class="btn btn-default" data-ajax="false" type="submit" tabindex="6">Submit</button>
        </div>                    
    </form>
</div>
